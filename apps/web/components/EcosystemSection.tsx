    ...
    return (
        <>
            ...
            {integrations.map((item, index) => (
                <div
                    key={index}
                    className={`flex-none w-[350px] h-[480px] ${item.bg} rounded-[3rem] p-10 flex flex-col justify-between border border-white/20 shadow-2xl relative group overflow-hidden`}
                >

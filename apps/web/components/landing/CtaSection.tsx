                ...
                <div className="relative rounded-3xl overflow-hidden p-12 md:p-20 text-center border border-white/10 bg-gradient-to-br from-slate-900 to-black">
                    ...
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[200%] h-full opacity-10 pointer-events-none">
                        <svg height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" width="100%">
                            <path d="M0 100 C 20 0, 50 0, 100 100" fill="transparent" stroke="#E84142" strokeWidth="0.5"></path>
                            <path d="M0 80 C 30 20, 70 20, 100 80" fill="transparent" stroke="#E84142" strokeWidth="0.5"></path>
                        </svg>
                    </div>
                    ...
                    <div className="relative flex flex-col sm:flex-row justify-center gap-6 z-10">
                        <button
                            ...
                            className="bg-[#E84142] hover:bg-[#E84142]/90 text-white px-10 py-4 rounded-full text-lg font-bold shadow-xl shadow-[#E84142]/20 transition-all hover:scale-105 active:scale-95 cursor-pointer"
                        >
                            Get Started Now
                        </button>
                        <button

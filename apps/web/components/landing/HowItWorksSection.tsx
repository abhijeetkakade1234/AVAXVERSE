...
export function HowItWorksSection() {
    return (
        <section className="relative w-full overflow-x-hidden bg-[#0a0a0f] text-slate-100 antialiased selection:bg-[#f42525]/30">
            {/* Background Effects */}
                ...
                <section className="relative min-h-[600px] flex items-center py-20 overflow-visible">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl opacity-40 mountain-glow pointer-events-none">
                        <img
                            ...
                            alt="Glowing red crystalline mountain peaks"
                        />
                    </div>
                    {/* Timeline Path */}
                        ...
                        <div className="flex flex-nowrap md:justify-between items-center gap-8 min-w-[1200px] py-12 px-10">
                            ...
                            <div className="flex flex-col items-center text-center group w-60">
                                <div className="glass-node w-20 h-20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform relative">
                                    ...
                                    <span className="material-symbols-outlined text-[#f42525]" style={{ fontSize: '36px' }}>badge</span>
                                </div>
                            ...
                            <div className="flex flex-col items-center text-center group w-60">
                                <div className="glass-node w-20 h-20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform relative">
                                    <div className="absolute inset-0 rounded-2xl bg-[#f42525]/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                    <span className="material-symbols-outlined text-[#f42525]" style={{ fontSize: '36px' }}>work_history</span>
                                </div>
                            ...
                            <div className="flex flex-col items-center text-center group w-60">
                                <div className="glass-node w-24 h-24 rounded-3xl flex items-center justify-center mb-6 scale-110 border-[#f42525]/40 bg-[#f42525]/10 relative shadow-[0_0_30px_rgba(244,37,37,0.2)]">
                                    ...
                                    <span className="material-symbols-outlined text-[#f42525]" style={{ fontSize: '44px' }}>task_alt</span>
                                </div>
                            ...
                            <div className="flex flex-col items-center text-center group w-60">
                                <div className="glass-node w-20 h-20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform relative">
                                    <div className="absolute inset-0 rounded-2xl bg-[#f42525]/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                    <span className="material-symbols-outlined text-[#f42525]" style={{ fontSize: '36px' }}>account_balance_wallet</span>
                                </div>
                            ...
                            <div className="flex flex-col items-center text-center group w-60">
                                <div className="glass-node w-20 h-20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform relative">
                                    <div className="absolute inset-0 rounded-2xl bg-[#f42525]/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                    <span className="material-symbols-outlined text-[#f42525]" style={{ fontSize: '36px' }}>security_update_good</span>
                                </div>
                        ...
                        <div className="lg:w-1/2">
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start p-6 rounded-2xl border border-white/5 bg-white/5 backdrop-blur-sm">
                                    <span className="material-symbols-outlined text-[#f42525]" style={{ fontSize: '28px', flexShrink: 0 }}>speed</span>
                                    <div>
                                ...
                                <div className="flex gap-4 items-start p-6 rounded-2xl border border-white/5 bg-white/5 backdrop-blur-sm">
                                    <span className="material-symbols-outlined text-[#f42525]" style={{ fontSize: '28px', flexShrink: 0 }}>hub</span>
                                    <div>
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="relative rounded-3xl overflow-hidden p-12 md:p-20 text-center border border-white/10 bg-gradient-to-br from-slate-900 to-black">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6 relative z-10">
                            <button className="bg-[#f42525] hover:bg-[#f42525]/90 text-white px-10 py-4 rounded-full text-lg font-bold shadow-xl shadow-[#f42525]/20 transition-all hover:scale-105 active:scale-95">
                                Get Started Now
                            </button>
                            <button className="bg-white/5 hover:bg-white/10 text-white border border-white/10 px-10 py-4 rounded-full text-lg font-bold backdrop-blur-sm transition-all hover:scale-105 active:scale-95">
                                View Documentation
                            </button>
                        </div>
                    </div>

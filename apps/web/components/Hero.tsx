  ...
  return (
    <section className="relative pt-10 pb-10 min-h-[85vh] flex items-center justify-center">
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <div className="relative glass-card rounded-[4rem] rounded-tl-[8rem] rounded-br-[8rem] p-12 md:p-24 flex flex-col items-center shadow-2xl backdrop-blur-3xl bg-white/15 text-center border-white/40 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-6 py-3 rounded-full mb-10 shadow-sm border border-white/30">
              <span className="text-white text-xs font-bold uppercase tracking-widest text-[10px]">
                The Avalanche Operating Layer
              </span>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold text-white mb-10 leading-[1.1] tracking-tight drop-shadow-2xl">

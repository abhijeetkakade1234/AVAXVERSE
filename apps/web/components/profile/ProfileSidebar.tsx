                    ...
                    <div className="flex flex-col items-center text-center mb-6">
                        ...
                        <div className="flex gap-3 mt-4">
                            {parsedSocials.twitter && (
                                <a aria-label="Twitter profile" className="p-2 bg-white/50 dark:bg-white/10 rounded-xl hover:text-[#8B82F6] transition-colors border border-white/20 dark:text-gray-300" href={`https://x.com/${parsedSocials.twitter}`} target="_blank" rel="noopener noreferrer">
                            ...
                            {parsedSocials.github && (
                                <a aria-label="GitHub profile" className="p-2 bg-white/50 dark:bg-white/10 rounded-xl hover:text-[#8B82F6] transition-colors border border-white/20 dark:text-gray-300" href={`https://github.com/${parsedSocials.github}`} target="_blank" rel="noopener noreferrer">

...
contract IdentityRegistry is IIdentityRegistry, Ownable {
    ...
    modifier onlyUpdater() {
        require(_authorizedUpdaters[msg.sender] || msg.sender == owner(), 'IdentityRegistry: not authorized');
        _;
    }
     ...
     */
    function incrementReputation(address user, uint256 amount) external onlyUpdater onlyRegistered(user) {
